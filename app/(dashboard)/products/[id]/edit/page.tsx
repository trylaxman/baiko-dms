    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-500">
          Update Baiko product pricing, MOQ and carton details.
        </p>
      </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              min={0}
              step="0.01"
              defaultValue={product.distributorPrice}
              className="w-full rounded-xl border px-4 py-3 outline-none focus:border-green-900"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              min={0}
              step="0.01"
              defaultValue={product.gstPercent}
              className="w-full rounded-xl border px-4 py-3 outline-none focus:border-green-900"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="number"
              min={1}
              defaultValue={product.cartonQty}
              className="w-full rounded-xl border px-4 py-3 outline-none focus:border-green-900"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="number"
              min={1}
              defaultValue={product.moqCartons}
              className="w-full rounded-xl border px-4 py-3 outline-none focus:border-green-900"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              min={0}
              step="0.01"
              defaultValue={product.weightInGram || 0}
              className="w-full rounded-xl border px-4 py-3 outline-none focus:border-green-900"
            />
          </div>
